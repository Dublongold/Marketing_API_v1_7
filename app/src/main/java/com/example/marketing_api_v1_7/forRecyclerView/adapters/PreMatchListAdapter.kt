...
class PreMatchListAdapter: ListAdapter<PreMatchSportsEvents, PreMatchListAdapter.MatchViewHolder>(
    object: DiffUtil.ItemCallback<PreMatchSportsEvents>() {
        override fun areItemsTheSame(
            oldItem: PreMatchSportsEvents,
            newItem: PreMatchSportsEvents
        ): Boolean {
